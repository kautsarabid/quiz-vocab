    ...
    for (let i = 0; i < incorrect.length; i++) {
      ...
      buttonSubmit[0].addEventListener('click', function () {
        for (let j = 0; j < v1.length; j++) {
          if (v1[0].value == 'look after' || v1[0].value == 'Look after' || v1[0].value == 'LOOK AFTER') {
          ...
          for (let j = 0; j < v2.length; j++) {
            if (v2[0].value == 'looked after' || v2[0].value == 'Looked after' || v2[0].value == 'LOOKED AFTER') {
          ...
          for (let j = 0; j < v3.length; j++) {
            if (v3[0].value == 'looked after' || v3[0].value == 'Looked after' || v3[0].value == 'LOOKED AFTER') {
          ...
          for (let j = 0; j < ving.length; j++) {
            if (ving[0].value == 'looking after' || ving[0].value == 'Looking after' || ving[0].value == 'LOOKING AFTER') {
      ...
      buttonSubmit[1].addEventListener('click', function () {
        for (let j = 0; j < v1.length; j++) {
          if (v1[1].value == 'overcome' || v1[1].value == 'Overcome' || v1[1].value == 'OVERCOME') {
          ...
          for (let j = 0; j < v2.length; j++) {
            if (v2[1].value == 'overcame' || v2[1].value == 'Overcame' || v2[1].value == 'OVERCAME') {
          ...
          for (let j = 0; j < v3.length; j++) {
            if (v3[1].value == 'overcome' || v3[1].value == 'Overcome' || v3[1].value == 'OVERCOME') {
          ...
          for (let j = 0; j < ving.length; j++) {
            if (ving[1].value == 'overcoming' || ving[1].value == 'Overcoming' || ving[1].value == 'OVERCOMING') {
      ...
      buttonSubmit[2].addEventListener('click', function () {
        for (let j = 0; j < v1.length; j++) {
          if (v1[2].value == 'determine' || v1[2].value == 'Determine' || v1[2].value == 'DETERMINE') {
          ...
          for (let j = 0; j < v2.length; j++) {
            if (v2[2].value == 'determined' || v2[2].value == 'Determined' || v2[2].value == 'DETERMINED') {
          ...
          for (let j = 0; j < v3.length; j++) {
            if (v3[2].value == 'determined' || v3[2].value == 'Determined' || v3[2].value == 'DETERMINED') {
          ...
          for (let j = 0; j < ving.length; j++) {
            if (ving[2].value == 'determining' || ving[2].value == 'Determining' || ving[2].value == 'DETERMINING') {
      ...
      buttonSubmit[3].addEventListener('click', function () {
        for (let j = 0; j < v1.length; j++) {
          if (v1[3].value == 'creep' || v1[3].value == 'Creep' || v1[3].value == 'CREEP') {
          ...
          for (let j = 0; j < v2.length; j++) {
            if (v2[3].value == 'crept' || v2[3].value == 'Crept' || v2[3].value == 'CREPT') {
          ...
          for (let j = 0; j < v3.length; j++) {
            if (v3[3].value == 'crept' || v3[3].value == 'Crept' || v3[3].value == 'CREPT') {
          ...
          for (let j = 0; j < ving.length; j++) {
            if (ving[3].value == 'creeping' || ving[3].value == 'Creeping' || ving[3].value == 'CREEPING') {
      ...
      buttonSubmit[4].addEventListener('click', function () {
        for (let j = 0; j < v1.length; j++) {
          if (v1[4].value == 'digest' || v1[4].value == 'Digest' || v1[4].value == 'DIGEST') {
          ...
          for (let j = 0; j < v2.length; j++) {
            if (v2[4].value == 'digested' || v2[4].value == 'Digested' || v2[4].value == 'DIGESTED') {
          ...
          for (let j = 0; j < v3.length; j++) {
            if (v3[4].value == 'digested' || v3[4].value == 'Digested' || v3[4].value == 'DIGESTED') {
          ...
          for (let j = 0; j < ving.length; j++) {
            if (ving[4].value == 'digesting' || ving[4].value == 'Digesting' || ving[4].value == 'DIGESTING') {
